...
public class BirthdayService {
    ...
    @Inject
    public BirthdayService(Context ctx) {
        this.ctx = ctx;
    ...
    public ContactInfo getContact(Uri contact) {
    ...
    public List<Event> upcomingBirthday() {
    ...
    public List<EventDebug> allBirthday() {
        Uri dataUri = ContactsContract.Data.CONTENT_URI;
    ...
    public ContentProviderResult[] performUpdate(ArrayList<ContentProviderOperation> ops) throws RemoteException, OperationApplicationException {
    ...
    public Map<Account, Long> getRawContactIds(Long contactId) {
